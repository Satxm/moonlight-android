...
public class PcGridAdapter extends GenericGridAdapter<PcView.ComputerObject> {
    ...
    @Override
    public void populateView(View parentView, ImageView imgView, View spinnerView, TextView txtView, TextView txtView2, ImageView overlayView, PcView.ComputerObject obj) {
