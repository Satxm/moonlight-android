...
public class PcGridAdapter extends GenericGridAdapter<PcView.ComputerObject> {
    ...
    private void updateOverlayIP(View parentView,ComputerDetails details) {
        ...
        if (details.activeAddress != null) {
            txtView2.setText(details.activeAddress.address);
        } else if (details.localAddress != null) {
            txtView2.setText(details.localAddress.address);
        } else if (details.ipv6Address != null) {
            txtView2.setText(details.ipv6Address.address);
        } else if (details.manualAddress != null) {
            txtView2.setText(details.manualAddress.address);
        } else if (details.remoteAddress != null) {
            txtView2.setText(details.remoteAddress.address);
        } else {
